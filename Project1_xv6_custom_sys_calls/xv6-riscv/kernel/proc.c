...
// Global read() syscall counter, protected by readcount_lock.
int readcount = 0;
...
// Atomically increment the system-wide read() call counter.
void
increment_readcount(void)
{
...
// Return the current system-wide read() call count.
int
getreadcount(void)
{
  int n;
